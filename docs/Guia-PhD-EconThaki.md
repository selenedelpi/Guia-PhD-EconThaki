...
El objetivo de esta sección es reducir las brechas respecto a los postulantes que provienen de universidades de Estados Unidos. Es decir, que puedas demostrar las características que buscan los comités de selección:
...
- En caso de no poder irte a un pregrado fuera, hacer intercambio por un semestre o dos en una universidad del extranjero ayuda, aún más si el ranking de esa universidad es más alto que tu universidad de origen y si tomas cursos intermedios o avanzados durante el intercambio. 
...
- El [MicroMaster en Data, Economics, and Development Policy](https://micromasters.mit.edu/dedp/) cubre varios temas y cursos relacionados a economía del desarrollo, y está dirigido por varios profesores de MIT y staff de J-PAL. Entre los profesores se encuentran [Esther Duflo](https://economics.mit.edu/faculty/eduflo) y [Abhijit Banerjee](https://economics.mit.edu/faculty/banerjee), laureados con el Premio en Memoria de Alfred Nobel de Economía en 2019 justamente por sus contribuciones metodológicas a la economía del desarrollo. Adicionalmente, un rendimiento destacado en estos cursos, pueden abrir las puertas a completar una [maestría en el MIT](https://economics.mit.edu/masters) y [otras instituciones](https://micromasters.mit.edu/dedp/pathways-masters/).
    ...
    El [Master's Program in DEDP](https://economics.mit.edu/masters) es probablemente la primera opción de admisión inversa a programas de posgrado en economía, particularmente en maestría. Sin embargo, en otras disciplinas, este tipo de selección ha ido un paso más allá incluyendo la posibilidad de acceder al Ph.D. El [MicroMaster en Data Science and Statistics](https://micromasters.mit.edu/ds/pathways-graduate-programs/), por ejemplo, ofrece la posibilidad de acceder al [PhD Program in Social & Engineering Systems de MIT](https://idss.mit.edu/academics/ses_doc/). Es posible que poco a poco estos mecanismos de selección se hagan más comunes e incluyan a otras disciplinas y otras instituciones educativas.
...
##### 3. Para conseguir profesores que te escriban cartas de recomendación {-}
...
- MPhil (1 año) + PhD (3/4 años): Universidades como University College London y University of Oxford en Inglaterra ofrecen estas opciones
...
## Ser R.A. (Asistente de Investigación) {#RAShip}
...
Si te encuentras cursando tu pregrado en economía, te recomendamos no sólo tomar las versiones más avanzadas de tus cursos requisito (macroeconomía, microeconomía y econometría), sino (y quizás más importante) tomar cursos en matemática con los que mencionamos en esta sección.
...
Con la excepción del Grupo 0 de cursos de pregrado (donde tus notas deberías ser muy buenas o excelentes), los cursos del Grupo 1 y Grupo 2 son exclusivamente para incrementar la competitividad de tu perfil y no son requisitos estrictamente hablando.
...
En algunas universidades se pide este ensayo de no más de 500 palabras en el que se te pide que expliques la importancia de la diversidad para ti, incluyendo parte de tu experiencia personal.
...
Es importante notar que aunque debes demostrar claramente cómo se alinean tus intereses al programa al que postulas, muchas profesoras y universidades saben que a lo largo de tus estudios irás afinando y quizás cambiando tus preferencias en investigación.
...
### Ejemplos de Programas Más Específicos
...
* [University of Gothenburg](https://www.gu.se/en/school-business-economics-law/economics/our-research/research-areas/environmental-economics/phd-program-in-environmental-economics)
* [University of Vermont](https://www.uvm.edu/gund/ecological-economics)


El programa de ARE Berkeley y Public Policy en Duke también tienen especializaciones en ambiente.

#### Political Economy / Government {-}
* [Harvard Kennedy School](https://www.hks.harvard.edu/educational-programs/doctoral-programs/phd-political-economy-government)
* [Stanford GSB](https://www.gsb.stanford.edu/programs/phd/fields/political-economics)
* [King’s College London](https://www.kcl.ac.uk/study/postgraduate/research-courses/political-economy-research-mphil-phd)
* [Chicago Harris](https://harris.uchicago.edu/research-impact/centers-institutes/project-political-reform/7-reasons)
* [Caltech](https://www.hss.caltech.edu/academics/graduate-studies/social-sciences-phd-program)
* [Georgetown](https://government.georgetown.edu/ph-d-in-government/#)
* [Cornell](https://government.cornell.edu/graduate)
* [University of Texas at Dallas](https://epps.utdallas.edu/about/programs/public-policy-and-political-economy/)
* [Duke](https://polisci.duke.edu/graduate/phd/fields/economy)
* [Carleton](https://carleton.ca/politicaleconomy/prospective-students/ph-d/)

## ¿A cuántas universidades debo aplicar?

Siguiendo otras guías como [esta](https://drive.google.com/file/d/1QozD6_4_bvMd2o-q-yh9Doc5aQ6i3nPV/view)la recomendación general es alrededor de entre 20 a 30 programas. El proceso de entrar a programas en economía suele ser muy competitivo y existe un fuerte componente azaroso, por eso la recomendación general es cuanto más programas mejor,^[Imaginemos que la probabilidad de entrar a un programa de doctorado (incondicionada a tus características) es de 3%. La probabilidad que te acepten en al menos una, asumiendo independencia y que postulas a 30, es $1-(1-0.03)^20=60\%$. Obvio si tienes características “mejor al promedio” esas probabilidades mejoran. Lo mismo, si aplicas a universidades menos competitivas.] pero eso dependerá sobre todo de tu restricción presupuestaria. Recuerda que el costo marginal de postular a un programa adicional suele ser marginal pues los requisitos que pide cada programa suelen ser los mismos. Usualmente quienes escriben tus cartas entienden esto y saben que tendrán que mandar las LoR a varios lugares. Solo es importante avisarles con anticipación y si se puede mandarles todo en una sola ocasión.  (Ver [Cartas de Recomendación]).

## Costos

* Los principales costos al 2021 estaban así:
 + GRE: $205 USD 
 + TOEFL/IELTS: $ 210 USD
 + Enviar el GRE: $27 USD cada universidad
 + Enviar el TOEFL: $20 USD cada universidad
 + App fee de las universidades: entre \$70 y \$200 USD 

* Suponiendo que aplicas a 10 universidades como mínimo gastarías USD \$1700 USD. Agregando el costo de los trámites con las traducciones, las clases o programas de apoyo de inglés o para rendir el GRE, al menos necesitarás haber ahorrado como mínimo $2500 USD para poder aplicar.
* Un cálculo general usual es gastar alrededor de $3.500 USD si postulas alrededor de 20 programas. Sabemos que esto representa una fuerte barrera a la entrada. Pero también sabemos que tener más info nos puede ayudar a organizarnos, así que la estrategia es comenzar a ahorrar con anticipación para este momento.
* El costo de postular es bastante alto, considerando los niveles de ingresos de Perú, pero ten en cuenta que la admisión financiada a un programa de Ph.D. incluyen fellowships que llegan a superar los $300,000.00. Toma el proceso como una inversión muy rentable.^[Si conoces una inversión con mayor rentabilidad y similares niveles de riesgo, recuerda que puedes contactarnos a contacto@econthaki.org]
* Para que manejes mejor tus finanzas, en la sección [Materiales] te dejamos una plantilla excel para que le hagas seguimiento a tus gastos. 
* En función a tu restricción presupuestaria, evalúa la cantidad de programas a los cuales puedes aplicar
* Aunque existe la opción de “fee waiver” (excepción de la obligación de pago), usualmente las universidades no incluyen que estudiantes internacionales puedan aplicar a él. No obstante, hay algunas para las cuales sí es posible (usualmente hay que mandar un mail explicando la situación). Si crees que puedes calificar, aquí hay algunos modelos de contenido de mail para solicitar este beneficio.
* Notar que no es posible pedir la reducción del fee para el GRE o el TOEFL. Esto solo aplica para ciudadanas en EE.UU.


## Terminé de aplicar, ¿y ahora?

### Recomendaciones sobre waitlists

Si has recibido “lista de espera” o “waitlist”, tendrás que esperar a que quienes ya han recibido una oferta indiquen si la aceptan o no. Este proceso puede durar hasta el último día de toma de decisiones/ofertas (usualmente, por convención, el 15 de abril). Aunque la espera puede ser tediosa, hay que averiguar tus probabilidades de salir de la waitlist para tomar una decisión informada. Una opción es preguntar específicamente a las Directoras del Comité de Admisión; otra, es que tus cartas pregunten directamente si tienen alguna conexión con tu universidad de interés. Finalmente, puedes revisar foros en donde la gente publica sus decisiones y ofertas para que te des una idea de cómo van ocurriendo las decisiones y sus tiempos; unos de los más usados son [GradCafe](https://www.thegradcafe.com/) y [URCH Forums](https://www.urch.com/forums/phd-economics/). No obstante, por salud mental, no recomendamos pasar mucho tiempo en este tipo de foros, o al menos no hasta tener una oferta. 

### Recomendaciones si te quedaste por poquito

Aunque no se cuenta con datos de acceso libre de todas las universidades, en Twitter circula [info](https://twitter.com/JakeVigdor/status/1366976399219646465)  que avala que entrar a Ph.D.s en Economía cada año parece estarse volviendo más competitivo. Esto es lo primero que hay que recordar. En segundo lugar, el proceso es extremadamente ruidoso: hay muchas historias de actuales estudiantes del PhD e investigadoras que fueron rechazadas en su primera ronda como [esta](https://twitter.com/jhaushofer/status/1363244242970284037). Por otro lado, gente muy buena termina no siendo aceptada en universidades top. Además, es un proceso con bastantes desigualdades entre países. Aunque es difícil, no es el fin del mundo y tú no te defines por la suma de tus logros académicos.

Si no tuviste ofertas o las ofertas que tuviste no fueron lo suficientemente atractivas la primera vez, no hay que tomárselo personal. Tienes un gran camino recorrido para el siguiente año y mejorar tu aplicación se te hará un poco más fácil. Aunque es poco usual que las universidades respondan a esto, podrías preguntar por feedback respecto a tu aplicación (luego del 15 de abril) y cómo podrías mejorarla. Además, podrías preguntarle a docentes específicas retroalimentación sobre tu perfil (aunque sin spamear).


## Consejos para elegir entre ofertas {#Consejoselegir}

Si tienes más de una oferta, ¡felicitaciones! Decidir será la parte más bonita del proceso, pero también una parte complicada. A continuación, tienes algunas sugerencias para tomar tu decisión.

**Financiamiento**

- Un aspecto importante de la oferta de admisión es el financiamiento. Si tienes que elegir entre dos ofertas, y solo una de ellas ofrece financiamiento completo, aquella con financiamiento es de todas maneras la que dominará a la otra. Salvo que tengas una diferencia de preferencias muy grande entre ambas y que tengas la posibilidad de financiarte externamente. 
- En casos menos extremos, la importancia del funding se mantiene, pero la comparación entre ofertas es menos evidente. Entre los criterios, tienes que averiguar si los financiamientos de cada oferta son suficientes para el costo de vida de la ciudad en la que realizarás los estudios. La calidad de vida que puedas tener será muy importante. Ten en cuenta que ingresar al Ph.D. no es sino uno de los primeros pasos de tu carrera académica, importa mucho que lo des bien, en buenas condiciones.
- Por otro lado, una vez que tienes la oferta de una o más universidades, estás en espacio de negociar. Es totalmente posible que puedas escribir un correo del tipo: “Estimada University of Z. Tengo mucho interés en asistir a su programa. Me preocupa un poco el financiamiento, no obstante. Estoy también considerando asistir a la X University, y allá me ofrecen este monto un poco mayor ajustando por el costo de vida. ¿Es posible mejorar las condiciones de mi oferta?” y que puedas obtener una respuesta favorable. Tener varias opciones no solo reduce el riesgo de que no te acepten en un programa, sino que también aumenta tus capacidades de negociar mejoras en tus ofertas.

**Fit**

- Otro aspecto importantísimo es, obviamente, la calidad de la educación. No la enlistamos en primer lugar porque sea menos importante que el financiamiento, sino porque la calidad entre programas es menos heterogénea que el financiamiento. Es decir, una de las universidades top 5 te va a ofrecer muchas más oportunidades que una universidad top 20. Pero al comparar entre la universidad top 6 vs. la top 9, por ejemplo, la diferencia absoluta no es muy fuerte y depende más de las características particulares de los programas y las tuyas.
- A excepción de los dos o tres programas en la cima del prestigio académico, el resto de departamentos tiene bastantes diferencias a nivel campo de estudio. Por ejemplo, según el ranking de USNews, Minnesota es mejor en macroeconomía que la mayor parte de programas mejor ubicados en el ranking general, lo mismo San Diego en econometría, entre muchos otros. Asimetrías similares ocurren también en otros rankings. Tienes que tener en consideración tus intereses de investigación particulares. Si tienes tus áreas de interés ya definidas, puedes averiguar mejor sobre esto conversando con tus cartas de recomendación, consultando con la comunidad de estudiantes (actuales PhD students de últimos años) y docentes en los visit days, y revisando los temas cubiertos por los Job Market Candidates (JMC) de cada universidad.
- Por otro lado, es común que los estudiantes de doctorado escojan áreas de investigación muy diferentes a las que pensaron que escogerían al ingresar a sus programas. Si tienes sospechas de que esto, lo más probable, te va a pasar a ti, deberías considerar más las ofertas de lugares con puntos fuertes más variados.
- Es clave que el programa doctoral que escojas organice con regularidad seminarios y eventos, con invitados de otras instituciones, en tus áreas de especialización de interés. Esto evidencia que hay bastante trabajo y discusión en esa área, y que están conectados con la investigación reciente.


**Potenciales advisors y productividad**

- La calidad de tu experiencia doctoral dependerá de la calidad de tus supervisores y del grupo de pares con los que compartirás tiempos de estudio y discusión. La probabilidad de que esto sea bueno depende de muchas cosas, pero es quizás lo más importante que debes considerar. En los visit days, o mediante los medios que dispongas para conversar con estudiantes actuales, aprovecha para preguntar si el faculty de tu interés:
Están aceptando estudiantes para asesorar.
   - ¿Qué clase de mentoras son?
   - ¿Son generosas con su tiempo? 
   - ¿Son de fácil acceso para conversar ideas de investigación? ¿Suelen co-autorear con sus asesoradas? 
   - ¿Hay riesgo serio de que abandonen la institución? ¿En qué parte del tenure clock están?¿Influye ello en su disponibilidad de asesorar más o menos estudiantes?
- Implícito en los anteriores puntos está que a partir de cierto umbral, el ranking es poco importante en predecir el valor agregado de los programas. En primer lugar, hay sesgo de selección. En segundo lugar, el proceso de selección es bastante ruidoso y ello se traduce también en la productividad final de los PhD en economía. Según la tabla adjunta por ejemplo, que viene de Coney y Önder (2014)^[Conley, J. P., y Önder, A. S. (2014). The research productivity of new PhDs in economics: The surprisingly high non-success of the successful. Journal of Economic Perspectives, 28(3), 205-16.], el percentil 80 de Cornell (top 20) acaba teniendo una productividad mayor a las medianas de MIT y Harvard (Top 2).
- El Ph.D. es uno de los primeros pasos en la carrera académica. Dónde vas importa, pero no es lo único y las diferencias no son insalvables. 
- No existe la universidad que sea mejor para todas. Por ello, las asesoras con las que puedas formar contactos y el ajuste del plan de estudios del programa al que vas a asistir deben ser piezas clave de tu decisión.

**Preguntas adicionales para los visit days**

Aprovecha los visit days para aclarar tus dudas y conocer mejor el programa. Estos espacios son invaluables para obtener información sobre los departamentos y conocer a las personas con las que vas a interactuar los próximos años. Si es posible conversar con los profesores de la facultad y los estudiantes, a continuación hay una lista de preguntas que podrías hacer:

- ¿Cómo es la interacción entre estudiantes?¿Son cooperativas? ¿O compiten entre sí debido a incentivos relacionados a recursos o financiamiento?
- ¿Hay mucha colaboración/coautoría entre los miembros de la facultad y estudiantes?¿A qué crees se deba?
- ¿Cómo es la experiencia de ser TA o Grad Student Instructor?¿Es una experiencia enriquecedora?¿Interfiere seriamente con tus actividades de aprendizaje o las fortalece?
- ¿Es Economía una especialidad popular en la universidad que atrae estudiantes de pregrado excelentes?
- ¿Cuáles son las mejores características del programa para estudiantes en mis áreas específicas de interés? - sobre todo si ya las tienes bien definidas - ¿Hay estudiantes trabajando en ellas? ¿Qué están haciendo?
- ¿Hay oportunidades para financiar proyectos de investigación que demanden fondos?¿Hay estudiantes haciendo uso de ellas?
- ¿Hay recursos como acceso a bases de datos y laboratorios?
- ¿Qué es lo que les gusta más (y menos) de su universidad?
- ¿Qué cantidad y frecuencia de seminarios hay en mis temas de interés? ¿Quiénes participan en ellos?
- ¿Qué recursos disponibles tienen los estudiantes para investigar? ¿Hay acceso a Virtual PCs/clusters y licencias de software?¿Es fácil acceder a ellas?
- Especialmente para estudiantes: ¿Qué hace el programa/la universidad cuando los estudiantes tienen problemas de salud mental?¿Ello pasa a menudo?
- ¿Cuál es el tamaño promedio de cada cohorte?¿Cuántas personas empiezan y terminan el programa?¿Las oportunidades y recursos alcanzan para todas?


**Para decidir**

- Rechaza ofertas apenas tengas la seguridad de que no irás a esa universidad. Pero no aceptes tu oferta definitiva con mucha prisa. Una vez que has convencido a un comité de selección de que te admita, este hará esfuerzos para que aceptes la oferta. En algunos casos, ello incluye aumentos de financiamiento sin que lo solicites. En general, siempre se puede negociar - esto es un consejo para todo en la vida.
- El 15 abril es la fecha límite que tienen los programas para responder, pero a veces hay ofertas luego de esa fecha. No es lo común, pero puede pasar y varía de cohorte a cohorte.
- Siempre queda la opción de no elegir ninguna oferta para decidir postular de nuevo, o para no hacerlo. Si después de interactuar con ellos te das cuenta de que los programas que te han escogidos no son para ti, es más que razonable volver a aplicar. Sobre todo si tienes oportunidades de mejorar tu perfil de aplicación.

## Solicitud de la Visa de Estudios

**Para EEUU (F1)**

Una vez que ya has elegido tu programa, para reservar tu cita para la visa de estudios, deberás seguir los siguientes pasos:

1. **Solicitar el formulario I-20**: Emitido por la Oficina para Estudiantes Internacionales de la universidad. Una vez aceptada la oferta, debes contactarte con tu oficina para iniciar el proceso lo antes posible.
2. **Anotar el ID de SEVIS en tu formulario I-20**: Se encuentra en la esquina superior izquierda de tu I-20. Debería verse algo así: N00XXXXX
3. **Pagar por el SEVIS**: esto costará $ 350
4. **Llenar el formulario DS-160**: Para hacer esto, necesitarás tu ID de SEVIS. Aquí lo completas.
5. **Completar su solicitud de cita para la visa y pagar por la misma**.^[Si lo pides desde la Embajada de EE.UU. en Lima, este es el link para hacerlo: https://ais.usvisa-info.com/es-pe/niv] Dependiendo del momento, puede existir la posibilidad de pedir un adelanto de cita.

## Financiamiento externo y becas

La mayor parte de programas de PhD incluyen paquetes de financiamiento como parte de la oferta de admisión. Como contraparte, los estudiantes retribuyen a la universidad horas de trabajo como asistentes de cátedra y asistentes de investigación, lo cual es parte importante también de la formación. Si bien esto es lo usual, hay ocasiones en las que las ofertas no incluyen financiamiento completo o simplemente no lo incluyen en absoluto. Por otro lado, el caso de las maestrías es el contrario. Aunque suelen tener fondos destinados a ayuda económica, cubren solo a una cantidad menor de personas admitidas.

En caso no hayas recibido una oferta financiada, conseguir financiamiento externo es un proceso más sencillo una vez que tienes la aceptación a un programa.

Algunas fuentes de financiamiento aplicables a programas de Estados Unidos y Europa sobre las que puedes averiguar son las siguientes:
...
- Beca Fundación Carolina: Beca completa para estudios de posgrado en España.
- [Global Korea Scholarship](http://www.pronabec.gob.pe/descargas2021/marzo/Beca%20Corea%20NIIED%20-%20Resumen%20general%20de%20la%20convocatoria.pdf): Beca completa del gobierno coreano para estudiar licenciatura, maestría o doctorado.

Para maestrías:

- Chevening. Para maestrías de un año en Reino Unido.
- OAS Academic Scholarships Program
- Becas “Lumieres” del Gobierno de Francia para estudios de posgrado. Beca completa para 1 o 2 años de maestría. Todas las áreas excepto enseñanza de idiomas.
- Reto Excelencia - SERVIR - Para trabajadores públicos
- OPEC Fund for International Development

Intercambios:

- Becas Alianza del Pacífico. Orientada principalmente a intercambios entre los países de la Alianza del Pacífico.
- [Becas ELAP](https://becas-sin-fronteras.com/beca/b10143-becas-canada-elap-intercambio/) para intercambios entre países de Latinoamérica y Canadá.
- [Becas DAAD](https://www.daad.de/de/laenderinformationen/amerika/peru/) para intercambios con Alemania.

Otros:

- [Beca Opportunity Funds](https://icpnachi.edu.pe/pdf/2021-opportunity.pdf): Esta beca es por parte de la Embajada de Estados Unidos y cubre vuelos y los gastos iniciales de preparación para la admisión a universidades de Estados Unidos, **incluyendo el pago de los exámenes estandarizados (TOEFL/GRE).**
- Becas Fundación Botín: Beca completa para el Programa de Fortalecimiento de la Función Pública para estudiantes latinoamericanos.

## Consejos Varios

- Doble checa todos los documentos subidos antes de mandarla. Sobre todo en las rondas con muchas aplicaciones, es probable equivocarse con alguno.
- Algunos documentos se piden de manera “opcional”. La recomendación general es que los mandes de todas maneras, a menos que creas que definitivamente no favorecen tu aplicación.
- Posiblemente, ahorrar el dinero necesario y llegar a obtener los puntajes deseados en los exámenes estandarizados te tome tiempo, pero recuerda que es preferible cumplir la mayor cantidad de cosas para demostrar que estás preparada/o para entrar al Ph.D y mandar señales fuertes. Aplica una vez que estés segura/o. Es común para estudiantes internacionales tener que sobre-prepararse para poder mandar una aplicación fuerte.
- Ya que en términos de tiempo, este proceso puede ser costoso y desgastante, sugerimos encontrar personas que estén en la misma situación y con las cuales haya confianza para poder cooperar (por ejemplo compartiendo recursos como este).
- Busca más oportunidades o consejos siguiendo #EconTwitter.

Revisa también [los recursos de la AEA](https://www.aeaweb.org/resources/students/grad-prep/considerations).

# Materiales

Para organizar tu postulación a universidades, te dejamos 2 plantillas. [Una](https://drive.google.com/file/d/1RXUbPCo115wYvfBTZyM-UBrAJV7-eNw2/view), de Alvin Christian, para darle seguimiento a tus aplicaciones; y [otra](https://drive.google.com/file/d/1uPy76s0EQfc8KPIJEs8zi6jDS9yuSQnj/view), de las amigas de “Aplicar desde México” que incluye una plantilla de gastos.

# Preguntas frecuentes

Existen muchas concepciones erradas respecto a quién puede acceder a un doctorado. Aquí listamos algunas preguntas frecuentes que una se hace sobre el doctorado. 

**¿Quiénes pueden hacer un doctorado en economía?**
¡Todas pueden acceder a un doctorado! Eso sí, necesitas poder demostrar los tres requisitos que te comentamos: habilidad para investigar, habilidad académica e inglés.

**¿Debo dedicarme a la academia si termino el doctorado?**
No necesariamente. Existe más de un camino luego de terminar el doctorado En la sección [¿A qué se dedica un PhD en economía?] detallamos los caminos que existen.

**¿Se requiere tener maestría para aplicar al doctorado?**
No se requiere maestría, pero es verdad que haber tomado cursos avanzados -y haber culminado la maestría- pueden representar una ventaja en la postulación, sobre todo si tus notas durante el pregrado no fueron estelares o si es muy difícil para el comité de admisión comparar tus notas al sistema de notas del país al cual aplicas.

**¿Debo tener un pregrado en economía para aplicar al Ph.D. en economía?**
No…

**¿Debo aplicar a un doctorado en economía si tengo un pregrado en economía?**
No. En la sección [Ejemplos de Programas Más Específicos], listamos opciones de muchas otras opciones de programas a los cuales puedes aplicar. Y existen muchos más que puedes elegir en función de tus intereses.

**¿Con cuánto tiempo de anticipación debo preparar mi aplicación?**
La postulación requiere mucho tiempo de preparación. Recomendamos al menos 1 a 2 años debido al tiempo que toma preparar los materiales y hacer competitivo tu perfil. Por ejemplo, para obtener cartas de recomendación fuertes, es muy recomendable contar con una buena relación con tus potenciales recomendadoras y esto toma tiempo. Tus cartas te pueden ayudar a mapear, de forma honesta, tus posibilidades.

**¿Se tiene que pagar por hacer un Ph.D.?**
La mayoría de los doctorados no cuestan nada, es más, te pagan un estipendio por hacerlo (por tu costo de oportunidad).

**Como estudiante internacional debo pagar fees para rendir los exámenes estandarizados aunque venga de un contexto no privilegiado, ¿hay alguna forma de no pagar estos fees?**
Como estudiante internacional, debes pagar el fee. No obstante existen programas que ayudan con recursos económicos durante el proceso de aplicación con el fee de los exámenes y otros como el programa Beca Opportunity Funds  que detallamos en la sección [Financiamiento externo y becas.

**¿Cuánto tiempo dura la temporada de aplicación al Ph.D.?**
Depende de universidad en universidad. Usualmente, los primeros deadlines para subir tu aplicación suelen ser a finales de noviembre y los últimos a finales de enero. Los resultados pueden aparecer a partir de enero del siguiente año hasta el 15 de abril, por convención entre los programas.

**¿Hay gente que podría apoyarme en el proceso de aplicación?**
Sí, gente que actualmente esté estudiando en algún programa de interés te podrá dar tips más específicos sobre cómo aplicar o cómo es el ambiente en aquel programa para cuando estés en la etapa de elegir entre opciones. Sobre todo gente peruana o latinoamericana puede ser de ayuda. La gente joven en la comunidad suele ser muy gentil. Solo ten mucho cuidado de no spamear.
...
Y ya sabes, si quieres, recomendamos leer la guía completa y preparar tu temporada de aplicación de forma anticipada y organizada.^[¡Gracias por leer hasta este último pie de página! Para confirmar este logro, por favor envía la foto de un oso a uno o más de los siguientes correos: selene.cueva@pucp.pe, gaby.lecaro@gmail.com, y  bdaza@umich.edu, con el asunto "Que tengas un día hermOSO". Los mayores éxitos en este proceso. Esperamos que todo esto haya sido de tu ayuda.]
